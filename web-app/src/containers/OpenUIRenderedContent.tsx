...
import { getOpenUILibrary } from '@/lib/openui'
...
interface OpenUIRenderedContentProps {
  content: string
...
export function OpenUIRenderedContent({
  content,
  openUIResponse,
  className,
  isUser,
